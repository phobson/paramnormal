...
latex_documents = [
    (master_doc, "paramnormal.tex", "paramnormal Documentation", "Paul Hobson", "manual"),
]
...
man_pages = [(master_doc, "paramnormal", "paramnormal Documentation", [author], 1)]
