...
class EmbeddedSphinxShell:
    ...
    def process_input(self, data, input_prompt, lineno):
        ...
        store_history = not (is_suppress and self.hold_count)
        ...
        if not is_okwarning:
            for w in ws:
                ...
                s += (
                    "Specify :okwarning: as an option in "
                    "the ipython:: block to suppress this message\n"
                )
                sys.stdout.write("\n\n>>>" + ("-" * 73))
                sys.stdout.write(s)
                sys.stdout.write("-" * 76 + "\n")
    ...
    def custom_doctest(self, decorator, input_lines, found, submitted):
        ...
        """
        from docs.sphinxext.custom_doctests import doctests
