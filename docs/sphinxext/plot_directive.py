...
from matplotlib import _pylab_helpers  # noqa
...
def run(arguments, content, options, state_machine, state, lineno):
    ...
    for j, (code_piece, images) in enumerate(results):
        ...
        # html
        src_link = source_link if j == 0 and config.plot_html_show_source_link else None
    ...
    with open(target_name, "w", encoding="utf-8") as f:
        code_escaped = unescape_doctest(code) if source_file_name == rst_file else code
